...
import valjevac.kresimir.pokemonApp.models.Error;
import valjevac.kresimir.pokemonApp.models.ErrorResponse;
...
public class ApiErrorHelper {
    ...
    private static String getErrorSource(int index) {
        ...
        if (errorResponse.getErrors().get(index).getSource() == null) {
            return "";
        }
    ...
    public static String getFullErrorLowercase(int index) {
